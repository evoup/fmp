 ...
 */
public class AdSetTemplate extends MadAbstractFacebookOperations implements AdSetOperations {
	private MadGraphApi graphApi;
	private RestTemplate restTemplate;
	private ObjectMapper mapper;

	public AdSetTemplate(MadGraphApi graphApi, RestTemplate restTemplate, ObjectMapper mapper, boolean authorized) {
		super(authorized);
