...
import org.springframework.social.facebook.api.MadGraphApi;
...
import org.springframework.social.facebook.api.impl.MadAbstractFacebookOperations;
 ...
 */
public class CreativeTemplate extends MadAbstractFacebookOperations implements CreativeOperations {

	private final MadGraphApi graphApi;
	private final RestTemplate restTemplate;


	public CreativeTemplate(MadGraphApi graphApi, RestTemplate restTemplate, boolean isAuthorizedForUser) {
	...
	public void deleteAdCreative(String creativeId) {
		requireAuthorization();
		restTemplate.delete(MadGraphApi.GRAPH_API_URL + creativeId);
	}
