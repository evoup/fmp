 ...
 */
public class AccountTemplate extends MadAbstractFacebookOperations implements AccountOperations {

	private final MadGraphApi graphApi;

	private final RestTemplate restTemplate;

	public AccountTemplate(MadGraphApi graphApi, RestTemplate restTemplate, boolean isAuthorizedForUser) {
