 ...
 */
public class CampaignTemplate extends MadAbstractFacebookOperations implements CampaignOperations {

	private final MadGraphApi graphApi;
	private final RestTemplate restTemplate;


	public CampaignTemplate(MadGraphApi graphApi, RestTemplate restTemplate, boolean isAuthorizedForUser) {
