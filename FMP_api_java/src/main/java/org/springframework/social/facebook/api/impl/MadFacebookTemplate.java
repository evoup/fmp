...
import org.springframework.social.facebook.api.impl.json.MadFacebookModule;
 ...
 * authentication. In those cases, you may use a {@link MadFacebookTemplate} that is
 ...
 * @author Craig Walls
 */
public class MadFacebookTemplate extends AbstractOAuth2ApiBinding implements MadFacebook {
	 ...
	 */
	public MadFacebookTemplate(String accessToken) {
		this(accessToken, null);
	}

	public MadFacebookTemplate(String accessToken, String applicationNamespace) {
		this(accessToken, applicationNamespace, null);
	}

	public MadFacebookTemplate(String accessToken, String applicationNamespace, String appId) {
		super(accessToken);
	...
	protected void configureRestTemplate(RestTemplate restTemplate) {
		restTemplate.setErrorHandler(new MadFacebookErrorHandler());
	}
	...
	protected MappingJackson2HttpMessageConverter getJsonMessageConverter() {
		...
		objectMapper.registerModule(new MadFacebookModule());
